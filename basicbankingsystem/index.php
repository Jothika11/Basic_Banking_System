...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/3.jpg" alt="Net Banking" width="1360" height="500" >
      <div class="carousel-caption">
    <h3> Easy Net Banking</h3>
    </div>
    </div>
    <div class="carousel-item">
      <img src="images/4.jpg" alt="Personal Loans" width="1360" height="500">
      <div class="carousel-caption  d-none d-md-block">
    <h3>Get Personal Loans</h3>
    </div>
    </div>
    <div class="carousel-item">
      <img src="images/5.jpg" alt="Savings" width="1360" height="500">
      <div class="carousel-caption">
    <h3>Savings</h3>
    </div>
    </div>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1><br>TSF Bank</h1><br>
      <p1> TSF Bank is the Seventh largest private sector bank in India. The Bank offers the entire spectrum of financial services to customer 
        segments covering Large and Mid-Corporates, MSME, Agriculture and Retail Businesses.TSF Bank has achieved consistent growth and with a 5 year CAGR (2015-16 to 2020-21) 
